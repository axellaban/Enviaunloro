...
export type Nido = {
  ...
  bot: boolean;
  /**
   * Si sus vuelos aparecen en la vista del resto: anónimos, pero con las
   * puntas donde de verdad están (ver RADIO_MUNDO_KM en lib/privacidad.ts).
   * Es el interruptor con el que alguien se saca de ese mapa.
